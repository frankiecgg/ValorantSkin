...
export const loginUsernamePassword = async (interaction, redirect_url, operationIndex=null) => {
    let login = await queueUsernamePasswordLogin(interaction.user.id, redirect_url);
